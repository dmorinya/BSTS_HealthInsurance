...
### 2019 vs 2020
y <- zoo(cardiology$Acts[year(cardiology$Date)<=2020 ], cardiology$Date[year(cardiology$Date)<=2020 ])
...
png("/Users/dmorina/Insync/dmorina@ub.edu/OneDrive Biz/Projectes/2022/0052022. MAPFRE/Mapfre/Papers/BSTS_HealthInsurance/Material Suplementari/cardiology_2019_2020.png")
plot(impact)
dev.off()
summary(impact)

### 2019 vs 2021
y <- cardiology$Acts[year(cardiology$Date)!=2022]
...
impact <- CausalImpact(bsts.model = bsts.model,
                       post.period.response = as.numeric(post.period.response))
png("/Users/dmorina/Insync/dmorina@ub.edu/OneDrive Biz/Projectes/2022/0052022. MAPFRE/Mapfre/Papers/BSTS_HealthInsurance/Material Suplementari/cardiology_2019_2021.png")
plot(impact)
dev.off()
summary(impact)
...
png("/Users/dmorina/Insync/dmorina@ub.edu/OneDrive Biz/Projectes/2022/0052022. MAPFRE/Mapfre/Papers/BSTS_HealthInsurance/Material Suplementari/cardiology_2019_2022.png")
plot(impact)
dev.off()
summary(impact)
