...
osteopathy <- data_ts[data_ts$Code_Real==54 & data_ts$Code_Esp==54 & data_ts$Code_Group=="30100" & data_ts$Id==7390, ]
...
### 2019 vs 2020
y <- zoo(osteopathy$Acts[year(osteopathy$Date)<=2020 ], osteopathy$Date[year(osteopathy$Date)<=2020 ])
...
png("/Users/dmorina/Insync/dmorina@ub.edu/OneDrive Biz/Projectes/2022/0052022. MAPFRE/Mapfre/Papers/BSTS_HealthInsurance/Material Suplementari/osteopathy_2019_2020.png")
plot(impact)
dev.off()
summary(impact)

### 2019 vs 2021
y <- osteopathy$Acts[year(osteopathy$Date)!=2022]
...
impact <- CausalImpact(bsts.model = bsts.model,
                       post.period.response = as.numeric(post.period.response))
png("/Users/dmorina/Insync/dmorina@ub.edu/OneDrive Biz/Projectes/2022/0052022. MAPFRE/Mapfre/Papers/BSTS_HealthInsurance/Material Suplementari/osteopathy_2019_2021.png")
plot(impact)
dev.off()
summary(impact)
...
png("/Users/dmorina/Insync/dmorina@ub.edu/OneDrive Biz/Projectes/2022/0052022. MAPFRE/Mapfre/Papers/BSTS_HealthInsurance/Material Suplementari/osteopathy_2019_2022.png")
plot(impact)
dev.off()
summary(impact)
