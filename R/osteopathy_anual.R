...
png("Papers/Paper 4 (BSTS)/Results/osteopathy_2019_2020.png")
plot(impact)
dev.off()
summary(impact)
...
impact <- CausalImpact(bsts.model = bsts.model,
                       post.period.response = post.period.response)
png("Papers/Paper 4 (BSTS)/Results/osteopathy_2019_2021.png")
plot(impact)
dev.off()
summary(impact)
...
impact <- CausalImpact(bsts.model = bsts.model,
                       post.period.response = post.period.response)
png("Papers/Paper 4 (BSTS)/Results/osteopathy_2019_2022.png")
plot(impact)
dev.off()
summary(impact)
