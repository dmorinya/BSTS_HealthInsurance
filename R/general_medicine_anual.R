...
generalm <- data_ts[data_ts$Code_Real==1 & data_ts$Code_Esp==1 & data_ts$Code_Group=="10100" & data_ts$Id== 1, ]
...
generalm <- generalm[year(generalm$Date)!=2023, ]
totals <- totals[year(totals$Date)!=2023, ]

### 2019 vs 2020
y <- zoo(generalm$Acts[year(generalm$Date)<=2020 ], generalm$Date[year(generalm$Date)<=2020 ])
...
png("/Users/dmorina/Insync/dmorina@ub.edu/OneDrive Biz/Projectes/2022/0052022. MAPFRE/Mapfre/Papers/BSTS_HealthInsurance/Material Suplementari/generalm_2019_2020.png")
plot(impact)
dev.off()
summary(impact)

### 2019 vs 2021
y <- generalm$Acts[year(generalm$Date)!=2022]
...
impact <- CausalImpact(bsts.model = bsts.model,
                       post.period.response = as.numeric(post.period.response))
png("/Users/dmorina/Insync/dmorina@ub.edu/OneDrive Biz/Projectes/2022/0052022. MAPFRE/Mapfre/Papers/BSTS_HealthInsurance/Material Suplementari/generalm_2019_2021.png")
plot(impact)
dev.off()
summary(impact)
...
png("/Users/dmorina/Insync/dmorina@ub.edu/OneDrive Biz/Projectes/2022/0052022. MAPFRE/Mapfre/Papers/BSTS_HealthInsurance/Material Suplementari/generalm_2019_2022.png")
plot(impact)
dev.off()
summary(impact)
