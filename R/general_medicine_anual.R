...
png("Papers/Paper 4 (BSTS)/Results/generalm_2019_2020.png")
plot(impact)
dev.off()
summary(impact)

### 2019 vs 2021
y <- generalm$Acts[year(generalm$Date)!=2020 & year(generalm$Date)!=2022]
...
impact <- CausalImpact(bsts.model = bsts.model,
                       post.period.response = post.period.response)
png("Papers/Paper 4 (BSTS)/Results/generalm_2019_2021.png")
plot(impact)
dev.off()
summary(impact)

### 2019 vs 2022
y <- generalm$Acts[year(generalm$Date)!=2020 & year(generalm$Date)!=2021]
...
impact <- CausalImpact(bsts.model = bsts.model,
                       post.period.response = post.period.response)
png("Papers/Paper 4 (BSTS)/Results/generalm_2019_2022.png")
plot(impact)
dev.off()
summary(impact)
